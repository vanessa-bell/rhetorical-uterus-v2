            ...
            <div className="panel-group col-md-offset-2 col-md-8" id="accordion" role="tablist" aria-multiselectable="false">
              <div className="panel panel-default">
                ...
                <div id="collapseOne" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                  <div className="panel-body">
                    “Unless and until it can be proven that the unborn child is not a living entity, then its right to life, liberty, and the pursuit of happiness must be protected.” — Ronald Reagan | <a className="red-call" href="#stances">read more</a>
                  </div>
                </div>
              </div>
              <div className="panel panel-default">
              ...
              <div className="panel panel-default">
                ...
                <div id="collapseThree" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                  <div className="panel-body">
                    "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod." - Uiod Oidlx | <a className="red-call" href="#stances">read more</a>
                  </div>
                </div>
              </div>
